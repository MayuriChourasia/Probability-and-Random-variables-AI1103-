...
%	&\multicolumn{1}{c}{colTag}	%Column 2\\ \hline %Last column
%	\endfirsthead
...
\hhline{|---|}
	...
	&\multicolumn{1}{p{\gnumericColB}|}%
	{\gnumericPB{\centering}\gnumbox{Card having girl's name on it is drawn}}
\\
\hhline{|---|}
	 \multicolumn{1}{|p{\gnumericColA}|}%
	{\gnumericPB{\centering}\gnumbox{X=1}}
	&\multicolumn{1}{p{\gnumericColB}|}%
	{\gnumericPB{\centering}\gnumbox{Card having boy's name on it is drawn}}
\\
\hhline{|-|-|-|}
\end{tabular}
